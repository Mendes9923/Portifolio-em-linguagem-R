...
setwd("C:/Users/Daniel Mendes/Downloads/Portifólio R/Tratamento, exploração e análise de dados Projeto 1/dados-covid-sp-master/dados-covid-sp-master/data")
...
ggplot(srag_atual, aes(x = DT_NOTIFIC, y = idade)) +
  geom_point() +
  labs(title = "Rela??o data de notifica??o e idade",
